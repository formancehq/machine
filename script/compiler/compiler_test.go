	...
	test(t, TestCase{
		...
		Expected: CaseResult{
			Instructions: []byte{
				...
				program.OP_IPUSH, 00, 00, 00, 00, 00, 00, 00, 00, // @foo, EUR/2, 0
	...
	test(t, TestCase{
		...
		Expected: CaseResult{
			Instructions: []byte{
				...
				program.OP_IPUSH, 00, 00, 00, 00, 00, 00, 00, 00, // @a, COIN, 0
				...
				program.OP_IPUSH, 02, 00, 00, 00, 00, 00, 00, 00, // [COIN 0], [COIN 0], [COIN @a 40], [COIN @a 10], 2
	...
	destination = @bob
		...
		Expected: CaseResult{
			Instructions: []byte{
				...
				program.OP_IPUSH, 00, 00, 00, 00, 00, 00, 00, 00, // @alice, EUR/2, 0
